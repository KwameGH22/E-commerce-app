  ...
  return (
    <div className="yx1wrapper mobile:h-[424px] w-full mobile:flex mobile:flex-col gap-5 mb-10
      ...
      <div className="image mobile:h-[200px] 
                      ...
                      laptop:bg-dt-earphone-home laptop:bg-cover laptop:bg-no-repeat laptop:bg-center laptop:w-full rounded-lg">
      ...
      <div className="text bg-[#F1F1F1] mobile:h-[200px] text flex flex-col justify-center mobile:px-5 gap-5 tablet:px-10  tablet:w-full laptop:pl-20 rounded-lg">
        <div className="text__name text-[28px]  font-bold">
          ...
          <Link>
              <button className=" px-4 py-3 font-extrabold border-2 border-black mobile:tracking-[1px] 
               tablet:tracking-[2px] 
               laptop:hover:bg-[#000000] laptop:hover:text-[#FFFF]">
                SEE PRODUCTS
              </button>
          </Link>
      </div>
