    ...
    >
      ...
      >
        ...
        <div className="recommendedItem1">
          <div
            className="recommendedImages mobile:bg-mob-zx7 mobile:h-[250px] mobile:mt-[50px] mobile:bg-no-repeat mobile:bg-center mobile:bg-cover
          tablet:bg-tb-zx7 tablet:h-[350px] tablet:w-[220px] tablet:bg-center tablet:bg-no-repeat tablet:bg-cover tablet:mt-[30px] tablet:rounded-lg
          laptop:bg-dt-zx7 laptop:h-[318px] laptop:w-[300px] laptop:bg-center laptop:bg-no-repeat laptop:bg-cover laptop:mt-[30px] laptop:rounded-lg"
          ></div>
